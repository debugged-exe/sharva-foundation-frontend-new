                  ...
                  <div className="row">
                    ...
                    <div className="col-md-10 ">
                              <div className="form-input textarea-joinus">
                                  <label htmlFor="message" className="title">Why do you want to Join Us?</label>
                                  <textarea name="message" id="" cols="20" rows="10"></textarea>
                              </div>
                          </div>
                          <div className="  col-md-6 ">
                              <div className="bg-brown rounded text-white ">
                                  <button type="submit" defaultValue="Send  Message" className="m-2 p-1 rounded joinus_submit_btn  gradient_btn btn-fill">Submit</button>
                              </div>
                          </div>
